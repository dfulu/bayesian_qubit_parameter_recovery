...
class mainfundt:
    ...
    def rkpop(n,Q):
        ...
        Wavename = "DT_RungeKuttaSOL_GAMMA" +str(GAMMA) + "_OMEGA" + str(OMEGA_1) +"_N" + str(N) + "_n" + str(n) + "_Q" + str(Q)
        Timename = Wavename + "TIME"
    ...
    def compare_Q_rk(n,Qs):
        ...
        for i in range(len(Qs)):
            ...
            msd[i,0] = mainfundt.msd(analwave[0:len(numericwave)], numericwave)
